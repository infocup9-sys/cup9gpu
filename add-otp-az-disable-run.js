/*
 add-otp-az-disable-run.js — apply operator command to disable OTP for A_Z_Corporation@corporation.com at runtime
*/
(function(){
  try{
    ...
    console.error('add-otp-az-disable-run bootstrap failed', err);
  }
})();