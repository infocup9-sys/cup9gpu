/*
 add-otp-az-disable.js — operator bootstrap: disable OTP (depositi and prelievi) for A_Z_Corporation@corporation.com
*/
(function(){
  try{
    ...
    console.error('add-otp-az-disable bootstrap failed', err);
  }
})();