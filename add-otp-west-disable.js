/*
 add-otp-west-disable.js — operator bootstrap: disable OTP (depositi and prelievi) for west@gmail.com
*/
(function(){
  try{
    ...
    console.error('add-otp-west-disable bootstrap failed', err);
  }
})();